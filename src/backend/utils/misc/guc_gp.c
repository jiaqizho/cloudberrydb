...
bool		optimizer_enable_window_hash_agg;
...
struct config_bool ConfigureNamesBool_gp[] =
{
	...
	{
		{"optimizer_enable_window_hash_agg", PGC_USERSET, DEVELOPER_OPTIONS,
		 gettext_noop("Enable create window hash agg."),
		 NULL,
		 GUC_NOT_IN_SAMPLE
		},
		&optimizer_enable_window_hash_agg, // TODO: remove it before merge
		false,
		NULL, NULL, NULL
	},
